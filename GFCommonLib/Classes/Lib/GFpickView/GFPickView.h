...
@protocol GFPickViewDelegate <NSObject>

@optional
-(void)toobarDonBtnHaveClick:(GFPickView *)pickView resultString:(NSString *)resultString andIndex:(NSInteger )index;

@end

@interface GFPickView : UIView
@property(nonatomic,weak) id<GFPickViewDelegate> delegate;
